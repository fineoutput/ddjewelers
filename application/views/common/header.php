     ...
     <div class="row h-100">
       <div class="col-md-12 d-flex align-items-center justify-content-center">
         <div  class="d-flex h-100 align-items-center">
          ...
          <a href="<?=base_url(); ?>Home/why_us"> <p>Why Buy From Us</p></a>
           ...
           <a href="<?=base_url(); ?>Home/lifetime_upgrades"> <p>LIFETIME UPGRADES</p></a>
           <i class="fa fa-phone mr-2 ml-3" style="font-size: 22px;"></i>
           <a href="<?=base_url(); ?>Home/services">  <p>SERVICES </p></a>
           <i class="fa fa-truck mr-2 ml-3" style="font-size: 22px;"></i>
           <a href="<?=base_url(); ?>Home/free_shipping"> <p>FREE SHIPPING </p></a>
           <i class="far fa-gem mr-2 ml-3" style="font-size: 22px;"></i>
           <a href="<?=base_url(); ?>Home/flexiblefinancing"><p>FLEXIBLE FINANCEING </p></a>
           <i class="fas fa-map-marker-alt mr-2 ml-3" style="font-size: 22px;"></i>
            <a href="<?=base_url(); ?>Home/visit_our_showroom"><p>VISIT OUR SHOWROOM </p></a>
           <i class="fa fa-envelope mr-2 ml-3" style="font-size: 22px;"></i>
          <a href="<?=base_url(); ?>Home/contact_us"> <p>CONTACT US </p></a>
            ...
            <div class="text-center d-none d-lg-block " id="totalCartItemsW">
              <a href="<?=base_url(); ?>Home/cart" class="carticon" style="position:relative;padding-right:rem;border-right: px solid #adadad;margin-Left:10px;">
                ...
                <small class="cart-value"><span><?$this->db->select('*');
								$this->db->from('tbl_cart');
								$this->db->where('user_id',$this->session->userdata('user_id'));
								$cart_count = $this->db->count_all_results(); echo $cart_count?></span></small>
                  <?}?>
              </a>
