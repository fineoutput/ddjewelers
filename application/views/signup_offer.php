...
.btn-primary{background-color:#1a3065;border-color:#122247;box-shadow:inset 0 1px 0 hsla(0,0%,100%,.15),0 1px 1px 2px 5px rgba(0,0,0,.075) rgba(0,0,0,.4);color:#fff;}
.btn-primary:focus,.btn-primary:hover{color:#fff;background-color:#101d3c;border-color:#1f3a79;}
.btn-primary:focus{box-shadow:0 0 0 .2rem rgba(54,67,98,.5);}
.btn-primary:disabled{color:#fff;background-color:#1a3065;border-color:#122247;}
.widget-emailform form .is-required .form-control-label{font-weight:700;}
.widget-emailform form .required{color:#333;}
@media (max-width:1199.98px){
.widget-emailform form{text-align:left;margin-bottom:2rem;}
}
.submission-spinner{margin-left:8px;}
.widget-location .location-listing .card{margin-bottom:1rem;padding:1rem;background-color:transparent;}
@media (max-width:575.98px){
.widget-location .location-listing .card{text-align:center;}
}
.widget-location .location-listing .card-hours:not(.style-canvas) h3{position:relative;font-size:1.1rem;}
@media (max-width:575.98px){
.widget-location .location-listing .card-hours:not(.style-canvas) h3{white-space:nowrap;}
}
@media (max-width:1199.98px){
.widget-location .location-listing .card-hours .hours-inner{width:100%;text-align:center;}
}
@media (max-width:991.98px){
.widget-location .location-listing .card-hours{display:flex;flex-flow:column nowrap;align-items:center;justify-content:center;width:100%;}
}
.widget-location .location-listing .card-hours .collapse{margin-bottom:1rem;}
.widget-location .location-listing .card-hours .hours-inner p[data-toggle=collapse]{font-size:.95rem;}
@media (max-width:1199.98px){
.widget-location .location-listing .card-hours .hours-inner{width:auto;text-align:left;}
}
.widget-location .location-listing .card-hours dl.row-hours{margin-bottom:0;}
.widget-location .location-listing .card-hours dl.row-hours.active{font-weight:700;}
.widget-location .location-listing .card-hours dl.row-hours dd{margin-bottom:0;}
.widget-location .location-listing .card-hours dl.row-hours dd{font-size:.95rem;}
.widget-location .location-listing .card-address{
  position:relative;
  font-size:inherit;
  /* padding-left:0; */
}
.widget-location .location-listing .card-address .actions{padding-top:.5rem;font-size:inherit;}
.widget-location h2{padding-bottom:.5rem;font-size:inherit;}
@media (max-width:575.98px){
.widget-location .card{padding:0;border:none;}
.widget-location h2{padding:0 0 .5rem!important;}
}
...
<!-- <input autocapitalize="off" autocomplete="off" autocorrect="off" spellcheck="false" id="id_verification_1" name="verification_1" type="text"> -->
    ...
    <div id="custom_form" class="g-recaptcha" style="visibility: hidden;"><div class="grecaptcha-badge" data-style="inline" style="width: 256px; height: 60px; box-shadow: gray 0px 0px 5px;"><div class="grecaptcha-logo"><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LdkI5EUAAAAAMbKtsuRGsc8b2f9n1Tb7c6LYQVo&amp;co=aHR0cHM6Ly93d3cuamV3ZWxwbHVzLmNvbTo0NDM.&amp;hl=en&amp;v=6OAif-f8nYV0qSFmq-D6Qssr&amp;size=invisible&amp;badge=inline&amp;cb=f3cqgfdgdukd" width="256" height="60" role="presentation" name="a-6p2028lj629z" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><div class="grecaptcha-error"></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;"></iframe></div>
