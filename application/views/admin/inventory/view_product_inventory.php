        ...
        <div class="row">
        <div class="col-lg-12">
        <a class="btn btn-info cticket" href="<?php echo base_url() ?>dcadmin/products/add_inventory"
     ...
     ?>
        <td><?php echo $data1->product_name ?></td>
         ...
         <li><a href="<?php echo base_url() ?>dcadmin/inventory/updateinventoryStatus/<?php echo
         base64_encode($data->id) ?>/inactive">Inactive</a></li>
         <?php } else { ?>
         <li><a href="<?php echo base_url() ?>dcadmin/inventory/updateinventoryStatus/<?php echo
         base64_encode($data->id) ?>/active">Active</a></li>
         <?php } ?>
         <li><a href="<?php echo base_url() ?>dcadmin/inventory/update_inventory/<?php echo
