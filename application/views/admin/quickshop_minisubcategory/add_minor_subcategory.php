<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Quick Shops: Add New Sub-Category (Level 3)
    </h1>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action=" <?php echo base_url()  ?>dcadmin/QuickshopMinisubcategory/add_minor_subcategory_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td> <input type="text" name="subcategory"  class="form-control" placeholder="" required value="" />  </td>
                    ...
                    <tr>
                      ...
                      <td> <input type="text" name="search_key" class="form-control" placeholder="" value="" /> </td>
                    </tr>
