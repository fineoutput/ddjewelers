        ...
        <div class="row">
        <div class="col-lg-12">
        <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/NewArrivals/add_products"
 ...
 -->
        ...
        <li><a href="<?php echo base_url() ?>dcadmin/NewArrivals/updateproductsStatus/<?php echo
        base64_encode($data->id) ?>/inactive">Inactive</a></li>
        <?php } else { ?>
        <li><a href="<?php echo base_url() ?>dcadmin/NewArrivals/updateproductsStatus/<?php echo
        base64_encode($data->id) ?>/active">Active</a></li>
        <?php } ?> -->
        <!-- <li><a href="<?php echo base_url() ?>dcadmin/NewArrivals/update_productss/<?php echo
        base64_encode($data->id) ?>">Edit</a></li> -->
        <li><a href="<?php echo base_url() ?>dcadmin/NewArrivals/product_details/<?php echo
        ...
        <a href="<?php echo base_url() ?>dcadmin/NewArrivals/delete_products/<?php echo
