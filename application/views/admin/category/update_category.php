      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="alert alert-danger alert-dismissible">
            ...
            <? echo $this->session->flashdata('emessage');$this->session->unset_userdata('emessage');  ?>
          </div>
          <? }  ?>
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="type" required>
                          ...
                          <option value="0" <?if($category_data->type==0){echo"selected";}?>>None</option>
                          <option value="1" <?if($category_data->type==1){echo"selected";}?>>Category ID</option>
                          <option value="2" <?if($category_data->type==2){echo"selected";}?>>Series No.</option>
                          <option value="3" <?if($category_data->type==3){echo"selected";}?>>SKU</option>
                        </select>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        $api=implode(',',$d_api)
                        ?>
                        <textarea name="api_id" class="form-control" rows="5" cols="50"><?=$api;?></textarea></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td> <input type="checkbox" name="finshed" class="" placeholder="" value="1" <? if($category_data->finshed == 1) { echo "checked";}else{ echo "";}?> />&nbsp&nbsp<lable> Finshed </lable>
                      </td>
                    </tr>
                    <tr>
