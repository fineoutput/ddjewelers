<div class="content-wrapper">
  <section class="content-header">
    <h1>
      View Sub-Category (Level 3)
    </h1>
  </section>
  <section class="content">
    <div class="row">
      <div class="col-lg-12">
        <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/minisubcategory/add_minisubcategory" role="button" style="margin-bottom:12px;"> Add Sub-Category</a>
                            ...
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                ...
                                <?php if ($data->is_active == 1) { ?>
                                  <li><a href="<?php echo base_url() ?>dcadmin/minisubcategory/updateminisubcategoryStatus/<?php echo
                                                                                                                            base64_encode($data->id) ?>/inactive">Inactive</a></li>
                                <?php } else { ?>
                                  <li><a href="<?php echo base_url() ?>dcadmin/minisubcategory/updateminisubcategoryStatus/<?php echo
                                                                                                                            base64_encode($data->id) ?>/active">Active</a></li>
                                <?php } ?>
                                <li><a href="<?php echo base_url() ?>dcadmin/minisubcategory/update_minisubcategory/<?php echo
