...
<td> <input type="text" name="subcategory"  class="form-control" placeholder="" required value="<?= $minisubcategory_data->subcategory; ?>" />  </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="category" id="category">
                          ...
                          foreach ($category->result() as $data) { ?>
                            <option value="<?= $data->id ?>" <?php if ($data->id == $minisubcategory_data->category) {
                                                                echo 'selected';
                                                              } ?>><?= $data->name ?></option>
                          <?php $i++;
                          } ?>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="subcategory" id="subcategory">
                          ...
                          foreach ($subcategory->result() as $data) { ?>
                            <option value="<?= $data->id ?>" <?php if ($data->id == $minisubcategory_data->subcategory) {
                                                                echo 'selected';
                                                              } ?>><?= $data->name ?></option>
                          <?php $i++;
                          } ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="type" required>
                          ...
                          <option value="0" <? if ($minisubcategory_data->type == 0) {
                                              echo "selected";
                                            } ?>>None</option>
                          <option value="1" <? if ($minisubcategory_data->type == 1) {
                                              echo "selected";
                                            } ?>>Category ID</option>
                          <option value="2" <? if ($minisubcategory_data->type == 2) {
                                              echo "selected";
                                            } ?>>Series No.</option>
                          <option value="3" <? if ($minisubcategory_data->type == 3) {
                                              echo "selected";
                                            } ?>>SKU</option>
                        </select>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <input type="checkbox" name="finshed" class="" placeholder="" value="1" <? if ($minisubcategory_data->finshed == 1) {
                                                                                                      echo "checked";
                                                                                                    } else {
                                                                                                      echo "";
