...
<div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-10">
                           <form action=" <?php echo base_url(); ?>dcadmin/minisubcategory/add_minisubcategory_data/<? echo base64_encode(2); ?>/<?=$id;?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td> <input type="text" name="subcategory"  class="form-control" placeholder="" required value="<?=$minisubcategory_data->subcategory;?>" />  </td>
</tr> -->
...
<tr>
 ...
 <td> <select class="form-control" name="category" id="category">
       ...
       <?php $i=1; foreach($category->result() as $data) { ?>
         <option value="<?=$data->id?>" <?php if($data->id == $minisubcategory_data->category){ echo 'selected'; }?> ><?=$data->name?></option>
         <?php $i++; } ?>
 </select>
...
<tr>
 ...
 <td> <select class="form-control" name="subcategory" id="subcategory">
       ...
       <?php $i=1; foreach($subcategory->result() as $data) { ?>
         <option value="<?=$data->id?>" <?php if($data->id == $minisubcategory_data->subcategory){ echo 'selected'; }?> ><?=$data->name?></option>
         <?php $i++; } ?>
 </select>
 <!-- <td> <input type="select" name="category"  class="form-control" placeholder=""  value="" />  </td> -->
</tr>
...
<td> <input type="text" name="name"  class="form-control" placeholder="" required value="<?=$minisubcategory_data->name;?>" />  </td>
</tr>
<tr>
...
<td>
  ...
  <option value="0" <?if($minisubcategory_data->type==0){echo"selected";}?>>None</option>
  <option value="1" <?if($minisubcategory_data->type==1){echo"selected";}?>>Category ID</option>
  <option value="2" <?if($minisubcategory_data->type==2){echo"selected";}?>>Series No.</option>
  <option value="3" <?if($minisubcategory_data->type==3){echo"selected";}?>>SKU</option>
</select>
</td>
</tr>
...
<?
$d_api=json_decode($minisubcategory_data->api_id);
$api=implode(',',$d_api)
?>
...
<td> <input type="number" name="seq"  class="form-control" placeholder=""  value="<?=$minisubcategory_data->seq;?>" />  </td>
</tr>

<tr>
<td> <strong>Finshed</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="checkbox" name="finshed"  class="" placeholder=""  value="1" <? if($minisubcategory_data->finshed == 1) { echo "checked";}else{ echo "";}?> />&nbsp&nbsp<lable> Finshed </lable> </td>
</tr>
<tr>
                      <td> <strong>Excluded Series Ex(1235,ch12)</strong> <span style="color:red;">*</span></strong> </td>
                      <td> <input type="text" name="exlude_series" class="form-control" placeholder="" value="<?=$minisubcategory_data->exlude_series;?>" /> </td>
                    </tr>

                    <tr>
                      <td> <strong>Excluded Sku Ex(1235,ch12)</strong> <span style="color:red;">*</span></strong> </td>
                      <td> <input type="text" name="exlude_sku" class="form-control" placeholder="" value="<?=$minisubcategory_data->exlude_sku;?>" /> </td>
                    </tr>
<tr>
                      <td> <strong>Include Series Ex(1235,ch12)</strong> <span style="color:red;">*</span></strong> </td>
                      <td> <input type="text" name="include_series" class="form-control" placeholder="" value="<?=$minisubcategory_data->include_series;?>" /> </td>
                    </tr>

                    <tr>
                      <td> <strong>Include Sku Ex(1235,ch12)</strong> <span style="color:red;">*</span></strong> </td>
                      <td> <input type="text" name="include_sku" class="form-control" placeholder="" value="<?=$minisubcategory_data->include_sku;?>" /> </td>
                    </tr>
                  <tr>
                    <td colspan="2" >
