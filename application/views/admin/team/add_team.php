<div class="content-wrapper">
    ...
    <td>
					...
					<input type="text" name="phone" maxlength="10" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');"  class="form-control" placeholder="" value="" />
	                             </td>
    										</tr>
                        <tr>
