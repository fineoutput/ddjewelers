                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                        ...
                        <select class="form-control" name="category" id="category">
                          ...
                          if (!empty($category)) {
                            ...
                            foreach ($category->result() as $data) { ?>
                              <option value="<?= $data->id ?>" <?php if ($data->id == $sub_category_data->category) {
                                                                  echo "selected";
                                                                } ?>><?= $data->name ?></option>
                          <?php $i++;
                            }
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" name="type" required>
                          ...
                          <option value="0" <? if ($sub_category_data->type == 0) {
                                              echo "selected";
                                            } ?>>None</option>
                          <option value="1" <? if ($sub_category_data->type == 1) {
                                              echo "selected";
                                            } ?>>Category ID</option>
                          <option value="2" <? if ($sub_category_data->type == 2) {
                                              echo "selected";
                                            } ?>>Series No.</option>
                          <option value="3" <? if ($sub_category_data->type == 3) {
                                              echo "selected";
                                            } ?>>SKU</option>
                        </select>
                      </td>
                    ...
                    <tr>
                      ...
                      <td> <input type="checkbox" name="finshed" class="" placeholder="" value="1" <? if ($sub_category_data->finshed == 1) {
                                                                                                      echo "checked";
                                                                                                    } else {
                                                                                                      echo "";
                    ...
                    <tr>
                      ...
                      <td> <textarea name="description" class="form-control" placeholder="" ><?=$sub_category_data->description;?></textarea> </td>
                    </tr>
                    <tr>
                      <td colspan="2">
