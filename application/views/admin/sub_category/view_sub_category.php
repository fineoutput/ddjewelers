<div class="content-wrapper">
        <section class="content-header">
                <h1>
                        View Sub-Category (Level 2)
                </h1>
        </section>
        <section class="content">
                <div class="row">
                        <div class="col-lg-12">
                                <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/sub_category/add_sub_category" role="button" style="margin-bottom:12px;"> Add Sub-Category</a>
                                                ...
                                                <div class="panel-body">
                                                        <div class="box-body table-responsive no-padding">
                                                                <table class="table table-bordered table-hover table-striped" id="userTable">
                                                                        ...
                                                                        <tbody>
                                                                                <?php $i = 1;
                                                                                foreach ($sub_category_data->result() as $data) { ?>
                                                                                        <tr>
                                                                                                <td><?php echo $i ?> </td>
