              ...
              <div class="col-lg-12">
                               ...
                               <div class="panel panel-default">
                                   <div class="panel-heading">
                                       <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Sub-Category (Level 2)</h3>
                                   </div>
                                   ...
                                   <div class="panel-body">
                                       <div class="col-lg-10">
                                          <form action=" <?php echo base_url()  ?>dcadmin/sub_category/add_sub_category_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td> <input type="number" name="seq"  class="form-control" placeholder=""  value="" required/>  </td>
</tr>
<tr>
...
<td> <textarea name="description"  class="form-control" placeholder=""  value="" ></textarea>  </td>
</tr>
                                 <tr>
                                   <td colspan="2" >
