...
<section class="content-header">
   <h1>
  Quick Shops: Update Sub Category  (Level 2)
  </h1>
...
<div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Sub Category </h3>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="col-lg-10">
                           <form action=" <?php echo base_url(); ?>dcadmin/QuickshopSubCategory/add_sub_category_data/<? echo base64_encode(2); ?>/<?=$id;?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<textarea type="text" name="description"  class="form-control" placeholder=""  value="<?=$sub_category_data->description;?>" style="height: 150px;" ><?=$sub_category_data->description;?></textarea>
</td>
</tr>
