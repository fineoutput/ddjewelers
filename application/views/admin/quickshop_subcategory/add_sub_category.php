<div class="content-wrapper">
               <section class="content-header">
                  <h1>
                 Quick Shops: Add New Sub Category  (Level 2)
                 </h1>
              ...
              <div class="col-lg-12">
                               ...
                               <div class="panel panel-default">
                                   ...
                                   <div class="panel-body">
                                       <div class="col-lg-10">
                                          <form action=" <?php echo base_url()  ?>dcadmin/QuickshopSubCategory/add_sub_category_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<textarea type="text" name="description"  class="form-control" placeholder=""  value="" style="height: 150px;"></textarea>
</td>
</tr>
