...
<tr>
 ...
 <td> <select class="form-control" name="category" id="category">
       ...
       <?php $i=1; foreach($category->result() as $data) { ?>
         <option value="<?=$data->id?>" <?php if($data->id == $minisubcategory2_data->category){ echo 'selected'; }?> ><?=$data->name?></option>
         <?php $i++; } ?>
 </select>
...
<tr>
 ...
 <td> <select class="form-control" name="subcategory" id="subcategory">
       ...
       <?php $i=1; foreach($subcategory->result() as $data) { ?>
         <option value="<?=$data->id?>" <?php if($data->id == $minisubcategory2_data->subcategory){ echo 'selected'; }?> ><?=$data->name?></option>
         <?php $i++; } ?>
 </select>
 <!-- <td> <input type="select" name="category"  class="form-control" placeholder=""  value="" />  </td> -->
</tr>
...
<select class="form-control" name="minorsubcategory" id="minorsubcategory">
       ...
       <?php $i=1; foreach($minisubcategory->result() as $data) { ?>
         <option value="<?=$data->id?>" <?php if($data->id == $minisubcategory2_data->minorsubcategory){ echo 'selected'; }?> ><?=$data->name?></option>
         <?php $i++; } ?>
 </select>
 <!-- <td> <input type="select" name="category"  class="form-control" placeholder=""  value="" />  </td> -->
</tr>
...
<td>
  ...
  <option value="1" <?if($minisubcategory2_data->type==1){echo"selected";}?>>Category ID</option>
  <option value="2" <?if($minisubcategory2_data->type==2){echo"selected";}?>>Series No.</option>
  <option value="3" <?if($minisubcategory2_data->type==3){echo"selected";}?>>SKU</option>
</select>
</td>
</tr>
<tr>
...
<td> <input type="checkbox" name="finshed"  class="" placeholder=""  value="1" <? if($minisubcategory2_data->finshed == 1) { echo "checked";}else{ echo "";}?> />&nbsp&nbsp<lable> Finshed </lable> </td>
</tr>
<tr>
