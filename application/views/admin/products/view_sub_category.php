        ...
        <h1>
          View SubCategory (Level 2)
        </h1>
        </section>
        <section class="content">
        <div class="row">
        <div class="col-lg-12">
        <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/products/view_category"
...
if(!empty($minisubcategory_da)){ ?>
  ...
  <a href="<?php echo base_url() ?>dcadmin/products/view_minisubcategory/<?php echo
  base64_encode($data->id) ?>">
    <button type="button" class="btn btn-default " >View SubCategory (Level 3) </button>
  </a>
