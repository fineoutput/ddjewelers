...
$cate_products_count= $this->db->count_all_results();
?>

 	 <td><?php echo $data->name." (".$cate_products_count.")"; ?></td>
      ...
      if(!empty($subcategory_da)){ ?>
        ...
        <a href="<?php echo base_url() ?>dcadmin/products/view_sub_category/<?php echo
        base64_encode($data->id) ?>">
          <button type="button" class="btn btn-default " >View SubCategory (Level 2) </button>
        </a>

      <?php }else { ?>

        <a href="<?php echo base_url() ?>dcadmin/products/view_products/<?php echo
        base64_encode($data->id) ?>/<?=base64_encode(3);?>">
