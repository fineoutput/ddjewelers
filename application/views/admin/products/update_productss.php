...
<td>
  <input type="text" name="minisubcategory" id="minisubcategory"  class="form-control" placeholder=""  value="<?=$minisub;?>">
</td>
</tr>
...
<td>
  <input type="text" name="minisubcategory2" id="minisubcategory2"  class="form-control" placeholder=""  value="<?=$minisub2;?>">
</td>
</tr>
