...
$this->db->where('id',base64_decode($minorsubcate_id));
$sub_cate_da= $this->db->get()->row();
if(!empty($sub_cate_da)){
  $subcate_id=$sub_cate_da->subcategory;
}else{
  $subcate_id= "";
}
?>

        <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/products/view_minisubcategory/<?=base64_encode($subcate_id);?>"
        role="button" style="margin-bottom:12px;"> Back</a>
        <div class="panel panel-default">
        <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View SubCategory (Level 4)</h3>
        </div>
        <div class="panel panel-default">
...
<td><?php echo $data->api_id ?></td>
        ...
        <div class="btn-group">
          ...
          base64_encode($data->id) ?>/<?=base64_encode(2);?>">
