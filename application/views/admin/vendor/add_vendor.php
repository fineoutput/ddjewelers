...
<td> <input type="text" name="address"  class="form-control" placeholder=""  value="" />  </td>
</tr>
  <tr>
<td> <strong>prefix</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="text" name="prefix"  class="form-control" placeholder="" required value="" />  </td>
</tr>
