...
<td> <input type="text" name="subcategory"  class="form-control" placeholder="" required value="<?= $minorsubcategory2_data->subcategory; ?>" />  </td>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="category" id="category">
                          ...
                          foreach ($category->result() as $data) { ?>
                            <option value="<?= $data->id ?>" <?php if ($data->id == $minorsubcategory2_data->category) {
                                                              echo 'selected';
                                                            } ?>><?= $data->name ?></option>
                          <?php $i++;
                          } ?>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="subcategory" id="subcategory">
                          ...
                          foreach ($subcategory->result() as $data) { ?>
                            <option value="<?= $data->id ?>" <?php if ($data->id == $minorsubcategory2_data->subcategory) {
                                                              echo 'selected';
                                                            } ?>><?= $data->name ?></option>
                          <?php $i++;
                          } ?>
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="minorsubcategory" id="minorsubcategory">
                          ...
                          foreach ($minorsubcategory->result() as $data) { ?>
                            <option value="<?= $data->id ?>" <?php if ($data->id == $minorsubcategory2_data->minorsubcategory) {
                                                              echo 'selected';
                                                            } ?>><?= $data->name ?></option>
                          <?php $i++;
                          } ?>
                    ...
                    <tr>
                      ...
                      <?
                      $d_api = json_decode($minorsubcategory2_data->api_id);
                      if (!empty($d_api)) {
                        $api = implode(',', $d_api);
                      } else {
                        $api = "";
