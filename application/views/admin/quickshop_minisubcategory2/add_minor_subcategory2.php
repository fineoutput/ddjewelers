<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Quick Shops: Add New Sub-Category (Level 4)
    </h1>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Sub-Category (Level 4)</h3>
          </div>
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action=" <?php echo base_url()  ?>dcadmin/QuickshopMinisubcategory2/add_minor_subcategory2_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="minorsubcategory" id="minorsubcategory">
                          ...
                          <?php $i = 1;
                          foreach ($minorsubcategory->result() as $data) { ?>
                            <option value="<?= $data->id ?>"><?= $data->name ?></option>
                          <?php $i++;
                          } ?>
                        </select>
