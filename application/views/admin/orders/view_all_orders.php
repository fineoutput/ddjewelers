...
if(!empty($da)){
	...
	$name="";
		...
		if(!empty($data->promocode)){ echo $name; }else{ echo "No Promocode"; }
...
$this->db->select('*');
      ...
      if(!empty($address_sa)){
        $addr_city = $address_sa->town_city;
        $addr_state = $address_sa->state;
        $addr_zipcode = $address_sa->postal_code;
				// $location_address= $address_sa->location_address;
				// $doorflat= $address_sa->doorflat;
				// $landmark= $address_sa->landmark;



				if(!empty($address_sa->address)){
 ...
 <!-- <td><?php
	...
	if(!empty($address_sa)){
			...
			if(!empty($location_address)){
				echo $doorflat.", ".$location_address;
			}else{
				echo "No Address Available";
			}
		}
...
?></td> -->
 ...
 <td>
   <?php
	 if(!empty($address_sa->customer_phone)){
			 echo $address_sa->customer_phone;
	 }else{
		 echo "NA";
	 }
   ?>
 ...
 <td>
	 <?php
		...
		// $this->db->where('id',$addr_city);
		// $city= $this->db->get()->row();
    //
		// if(!empty($city)){ echo $city->city_name; }
...
<!-- <?php      //   echo $addr_city;?> -->
 ...
 <td>
	 ...
	 // $this->db->where('id',$addr_state);
	 // $state= $this->db->get()->row();
   //
	 // if(!empty($state)){ echo $state->state_name; }
