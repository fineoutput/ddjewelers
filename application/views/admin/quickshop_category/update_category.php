...
<div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-10">
                           <form action=" <?php echo base_url(); ?>dcadmin/QuickshopCategory/add_category_data/<? echo base64_encode(2); ?>/<?=$id;?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<textarea type="text" name="description"  class="form-control" placeholder=""  value="<?=$category_data->description;?>" style="height: 150px;" ><?=$category_data->description;?></textarea>
</td>
</tr>
