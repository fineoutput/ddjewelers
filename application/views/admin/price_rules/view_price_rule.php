<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12">
        <a class="btn btn-info cticket" href="<?php echo base_url() ?>dcadmin/price_rule/add_price_rule" role="button" style="margin-bottom:12px;"> Add Price Rule</a>
            ...
            <div class="panel-body">
              <div class="box-body table-responsive no-padding">
                <table class="table table-bordered table-hover table-striped" id="userTable">
                  ...
                  <tbody>
                    <?php $i=1; foreach ($price_rule_data->result() as $data) { ?>
                    <tr>
                      <td><?php echo $i ?> </td>
