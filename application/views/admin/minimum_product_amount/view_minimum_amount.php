...
<table class="table table-bordered table-hover table-striped" id="userTable">
  <thead>
      <tr>
        ...
        <tbody>
        	<?php $i=1; foreach($cost_data->result() as $data) { ?>
<tr>
<td><?php echo $i ?> </td>
...
<li><a href="<?php echo base_url() ?>dcadmin/Minimum_product_amount/update_minimum_amount/<?php echo base64_encode($data->id) ?>">Edit</a></li>
</ul>
</div>
</div>
