		...
		<h1>
			Min. Item Cost (<=) </h1>
				<ol class="breadcrumb">
					...
					<li class="active">View Min. Item Cost (<=) </li>
				</ol>
	</section>
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Min. Item Cost (<=) </h3>
					</div>
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="box-body table-responsive no-padding">
								<table class="table table-bordered table-hover table-striped" id="userTable">
									...
									<tbody>
										<?php $i = 1;
										foreach ($cost_data->result() as $data) { ?>
											<tr>
												<td><?php echo $i ?> </td>
												...
												<td>
													<div class="btn-group" id="btns<?php echo $i ?>">
														<div class="btn-group">
															<a href="<?php echo base_url() ?>dcadmin/Minimum_product_amount/update_minimum_amount/<?php echo base64_encode($data->id) ?>"><button type="button" class="btn btn-default">
																	Edit</button></a>
