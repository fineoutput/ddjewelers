        ...
        <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/QuickshopProducts/view_minisubcategory2/<?=$minsubcateg_id;?>"
        role="button" style="margin-bottom:12px;"> Back</a>

        <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/QuickshopProducts/add_products"
