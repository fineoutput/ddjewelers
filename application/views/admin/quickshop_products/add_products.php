      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action=" <?php echo base_url()  ?>dcadmin/QuickshopProducts/add_products_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td> <select class="form-control" name="sub_category" id="sub_category" required>
                    ...
                    <tr>
                      <td> <strong>Finished</strong> <span style="color:red;">*</span></strong> </td>
                      <td> <input type="checkbox" name="finished" class="" placeholder="" value="1" />&nbsp&nbsp<lable> Finished </lable>
                      </td>
                    </tr>
                    <tr>
                    <tr>
  ...
  $(document).ready(function() {
    $("#category").change(function() {
      ...
      if (vf == "") {
        ...
        $.ajax({
          url: base_url + "dcadmin/QuickshopProducts/getSub_category?isl=" + vf,
          data: '',
          type: "get",
  ...
  $(document).ready(function() {
    $("#sub_category").change(function() {
      ...
      if (vf == "") {
        ...
        $.ajax({
          url: base_url + "dcadmin/QuickshopProducts/getminiSub_category?isl=" + vf,
          data: '',
          type: "get",
          success: function(html) {
            if (html != "NA") {
  ...
  $(document).ready(function() {
    $("#minisubcategory").change(function() {
      ...
      if (vf == "") {
        ...
        $.ajax({
          url: base_url + "dcadmin/QuickshopProducts/getminiSub_category2?isl=" + vf,
          data: '',
          type: "get",
          success: function(html) {
            if (html != "NA") {
