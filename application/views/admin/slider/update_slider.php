...
<div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Slider1 </h3>
                    </div>
...
<td> <input type="text" name="name"  class="form-control" placeholder=""  value="<?=$slider_data->name;?>" />  </td>
</tr>
<tr>
<td> <strong>Url</strong>  <span style="color:red;">*</span></strong> </td>
<td> <input type="url" name="url"  class="form-control" placeholder=""  value="<?=$slider_data->url;?>" />  </td>
</tr>
<tr>
...
<td> <input type="number" name="seq"  class="form-control" placeholder=""  value="<?=$slider_data->seq;?>" />  </td>
</tr>
