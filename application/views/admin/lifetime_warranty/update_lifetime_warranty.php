                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td> <input type="text" name="page_title" class="form-control" placeholder="" required value="<?= $lifetime_warranty_data->page_title; ?>" /> </td>
                    </tr>
                    <tr>
                      <td> <strong>Keyword</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <textarea name="keyword" class="form-control" placeholder="" required id="editor1"><?= $lifetime_warranty_data->keyword; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td> <strong>Meta Description</strong> <span style="color:red;">*</span></strong> </td>
                      <td>
                        <textarea name="dsc" class="form-control" placeholder="" required id="editor1"><?= $lifetime_warranty_data->dsc; ?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="2">
