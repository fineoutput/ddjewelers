...
<h3 class="panel-title"><i class="fa fa-money fa-fw"></i>  Method</h3>
</div>
...
<div class="col-lg-10">
<form action="<?php echo base_url() ?>dcadmin/Method/add_method_data/<?php echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td>
<input type="text" name="max" class="form-control" placeholder=""  value="" />
</td>
</tr>
