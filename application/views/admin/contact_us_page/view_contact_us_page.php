<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">View Contact Us Page</li>
        </ol>
    </section>
    <section class="content">
        <div class="row">
            <div class="col-lg-12">
                <!-- <a class="btn btn-info cticket" href="<?php echo base_url() ?>dcadmin/Contact_us_page/add_contact_us_page" role="button"style="margin-bottom:12px;"> Add Contact_us_page</a> -->
                        ...
                        <div class="panel-body">
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-bordered table-hover table-striped" id="userTable">
                                    ...
                                    <tbody>
                                        <?php $i = 1;
                                        foreach ($contact_us_page_data->result() as $data) { ?>
                                            <tr>
                                                <td><?php echo $i ?> </td>
...
<?php } else { ?>
<li><a href="<?php echo base_url() ?>dcadmin/Contact_us_page/updateContact_us_pageStatus/<?php echo base64_encode($data->id) ?>/active">Active</a></li>
<?php        }   ?> -->
                                                                <li><a href="<?php echo base_url() ?>dcadmin/Contact_us_page/update_Contact_us_page/<?php echo base64_encode($data->id) ?>">Edit</a></li>
