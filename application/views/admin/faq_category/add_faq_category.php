...
<div class="col-lg-10">
<form action="<?php echo base_url() ?>dcadmin/Faq_category/add_faq_category_data/<? echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td>
<input type="text" name="sequence"  onkeypress="return isNumberKey(event)" class="form-control" placeholder="" required value="" />
</td>
</tr>   
