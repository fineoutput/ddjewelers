                ...
                <div class="row ">
                    ...
                    <div class="col-md-4 col-sm-6 p-0">
                        ...
                        <div class="px-3 border  pt-0 ">
                            ...
                            <form style="margin-top: 15px;" method="post" action="<?=base_url()?>Order/apply_promocode">
                            ...
                            <div class=" border-bottom bg-light py-3">
                                ...
                                ?>
                                    ...
                                    <p style="color:red">No Shipping Method Found. Please Contact To Admin</p>
                                <? } ?>
                            </div>
