  ...
  <div class="container-fluid pl-5 pr-5 pt-3 pb-5">
    <div class="row">
      <div class="col-md-12 page_span">
        <p><a href="<?=base_url()?>"><span>Home</span></a> > <span>New Arrivals</span> </p>
      </div>
    </div>
    <div class="row ">
      ...
      <div class="col-md-12">
        <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="row ">
                            <div class="col-md-6 mb-4 hrds">
                                <h1 class="r-title">
                                  New Arrivals (<?=$product_count;?>)
                    ...
                    <div class="row w-100">
                    <?php $i=1; foreach($product->result() as $data) { ?>

                        <div class="col-md-3 col-4 searchColumn">
                        <a href="<?=base_url(); ?>Home/new_arrive_product_detail/<?=$data->id?>">
                            <p class="text-center"><?=$data->product_id?></p>
