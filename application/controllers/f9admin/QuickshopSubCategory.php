<?php
    if ( ! defined('BASEPATH')) exit('No direct script access allowed');
       ...
       class QuickshopSubCategory extends CI_finecontrol{
       function __construct()
         ...
         public function view_sub_category(){
            ...
            if(!empty($this->session->userdata('admin_data'))){
              ...
              $this->load->view('admin/quickshop_subcategory/view_sub_category');
             ...
             redirect("login/admin_login","refresh");
              ...
              public function add_sub_category(){
                 ...
                 if(!empty($this->session->userdata('admin_data'))){
                   ...
                   $this->load->view('admin/common/header_view',$data);
                   $this->load->view('admin/quickshop_subcategory/add_sub_category');
                   $this->load->view('admin/common/footer_view');
               ...
               public function update_sub_category($idd){
                   ...
                   if(!empty($this->session->userdata('admin_data'))){
                     ...
                     $this->load->view('admin/common/header_view',$data);
                     $this->load->view('admin/quickshop_subcategory/update_sub_category');
                     $this->load->view('admin/common/footer_view');
...
if($file_check!=4){
         ...
         $image_upload_folder = FCPATH . "assets/uploads/quicksub_category/";
                     if (!file_exists($image_upload_folder))
                     {
                         mkdir($image_upload_folder, DIR_WRITE_MODE, true);
                     }
                     $new_file_name="quicksub_category".date("Ymdhms");
           ...
           //$this->session->set_flashdata('emessage',$upload_error);
             //redirect($_SERVER['HTTP_REFERER']);
                     ...
                     else
                     {
                         ...
                         $videoNAmePath = "assets/uploads/quicksub_category/".$new_file_name.$file_info['file_ext'];
  ...
  'seq'=>$seq,
           ...
           $last_id=$this->base_model->insert_table("tbl_quickshop_subcategory",$data_insert,1) ;
...
if(!empty($img)) { if(empty($nnnn2)){ $nnnn2 = $img; } }else{ if(empty($nnnn2)){ $nnnn2= ""; } } }
  ...
  'seq'=>$seq,
             ...
             $this->db->where('id', $idw);
             $last_id=$this->db->update('tbl_quickshop_subcategory', $data_insert);
           }
                       if($last_id!=0){
      ...
      redirect($_SERVER['HTTP_REFERER']);
       ...
       redirect("login/admin_login","refresh");
               ...
               public function updatesub_categoryStatus($idd,$t){
                        ...
                        $this->db->where('id', $id);
                       $zapak=$this->db->update('tbl_quickshop_subcategory', $data_update);
