<?php
  ...
  'phone'=>$phone,
           ...
           if($last_id!=0){
                   $this->session->set_flashdata('smessage','User inserted successfully');
 ...
 $da=$dsa->row();
  ...
  'phone'=>$phone,
             ...
             if($last_id!=0){
                     $this->session->set_flashdata('smessage','User updated successfully');
                     redirect("dcadmin/users/view_users","refresh");
                    }
                     else
                         {
       ...
       redirect("login/admin_login","refresh");
               ...
               public function updateusersStatus($idd,$t){
                       ...
                       $zapak=$this->db->update('tbl_users', $data_update);
                            ...
                            if($zapak!=0){
                              $this->session->set_flashdata('smessage','User status updated successfully');
                            redirect("dcadmin/users/view_users","refresh");
                                    }
                                    else
                                    {
 ...
 if($zapak!=0){
        ...
        redirect("dcadmin/users/view_users","refresh");
             ...
             $this->session->set_flashdata('emessage','Sorry you are not super admin you dont have permission to delete anything');
               redirect($_SERVER['HTTP_REFERER']);
            }
