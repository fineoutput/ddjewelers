<?php
    if ( ! defined('BASEPATH')) exit('No direct script access allowed');
       ...
       class AskQuestions extends CI_finecontrol{
       function __construct()
         ...
         public function view_askquestions(){
            ...
            if(!empty($this->session->userdata('admin_data'))){
              ...
              // exit;
                           ...
                           $this->db->select('*');
               $this->db->from('tbl_ask_questions');
               //$this->db->where('id',$usr);
               $data['ask_ques_data']= $this->db->get();

              $this->load->view('admin/common/header_view',$data);
              $this->load->view('admin/ask_questions/view_ask_questions');
 ...
 //                     );
 //             $this->db->where('id', $idw);
 //             $last_id=$this->db->update('tbl_contact_us', $data_insert);
 //           }
 //                       if($last_id!=0){
 ...
 //
 //                        $this->db->where('id', $id);
 //                       $zapak=$this->db->update('tbl_contact_us', $data_update);
 //
 //                            if($zapak!=0){
 //                            redirect("dcadmin/contact_us/view_contact_us","refresh");
 //                                    }
 ...
 //                     $img=$da->image;
 //
 // $zapak=$this->db->delete('tbl_contact_us', array('id' => $id));
 // if($zapak!=0){
 //        $path = FCPATH .$img;
 //          unlink($path);
 //        redirect("dcadmin/contact_us/view_contact_us","refresh");
